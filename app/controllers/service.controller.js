...
exports.getAll = async (req, res, next) => {
  try {
    const allService = await Service.find({}).populate("settings.renters.renter");
    res.json(
      responseData(
        true,
        { services: allService },
...
exports.findById = async (req, res) => {
  try {
    ...
    const serviceDetail = await Service.findById(id).populate("settings.renters.renter");
    return res.json(
      responseData(
        true,
...
exports.getRentersByOption = async (req, res) => {
  try {
    ...
    const serviceDetail = await Service.findOne({ _id: id }).populate("settings.renters.renter");
