...
exports.findById = async (req, res) => {
    try {
        ...
        const serviceDetail = await Service.findById(id).populate("renters.renter")
        return res.json(responseData(true, { service: serviceDetail }, "Lấy thông tin dịch vụ thành công"))
    } catch (e) {
        return res.json(responseData(false, {}, "Lỗi máy chủ"))
    }
}